...
<a href="deleteall.php"><input style="    border-radius: 10px; border:#fff ; color: #ffffff;
    text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
	background-image: linear-gradient(to bottom,#cc0000, #8b0303);

" type='submit'  value='حذف الكل' /></a></div>
...
"> <?php echo $row ['date']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;     vertical-align: middle;
"> <?php echo $row ['Donor1']; ?><br>
<?php echo $row ['Donor2']; ?><br>
<?php echo $row ['Donor3']; ?><br>
<?php echo $row ['Donor4']; ?></td>
								<td style="text-align:center; word-break:break-all; width:200px;     vertical-align: middle;
