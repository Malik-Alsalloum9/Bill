...
<?php require_once('includes/session.php');
      ...
      $sqlE =mysqli_query($mysqli,"SELECT * FROM employees WHERE id='{$_SESSION['id']}'");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="line"></div> 
                            ...
                            $namek = mysqli_real_escape_string($mysqli,$_POST['fnamek']);
                ...
                $sql = "UPDATE employees set name='$name',surname='$surname',email='$email',joined='$joined',gender='$gender',phone='$phone',tmp='$tmp',employee_id='$employee_id' WHERE id='{$_SESSION['id']}'";
                ...
                $sqli = "UPDATE INTO picture(name,tmp)VALUES('$fileNameNew','$tmp')";
        ...
        <div class="col-lg-6">
            <label>Name</label>
              <input type="text" class="form-control" name="fname" pattern="[A-Za-z]{3,}" value="<?php echo $eprow['name'];?>" required>
            </div>   <div class="col-lg-6">
            <label>Namek</label>
              <input type="text" class="form-control" name="fnamek" pattern="[A-Za-z]{3,}" required>
            </div>  
             <div class="col-lg-6">
            <label>Surname</label>
