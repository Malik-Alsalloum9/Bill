...
<html lang="ar">
    ...
    <body>
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading" style="font-size: 25px">الملاحظات</div>
                     ...
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td>
                  <a href="v_issue.php?edited=1&idx=<?php echo $row['id']; ?>" data-toggle="modal" class="btn btn-danger"><span class="fa fa-times"></span> حذف</a> || <a  data-toggle="modal" class="btn btn-warning"><span class="fa fa-user"></span>   المرسل</a> 
                              </td>
                          </tr>
                          <?php
